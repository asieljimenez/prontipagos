    ...
    $(document).ready(function(){
		...
		function configSingUp(){
            ...
            baseUrl ="https://www.prontipagos.com/registro/";
			  ...
			  var baseSignUpEmbeddedNlp=baseUrl+"signUp_Embedded_landing.html";
			  ...
			  var paramsNlp = { ...params, landingId: 54 };

			  $(".iframeSignUpNlp").attr('src',baseSignUpEmbeddedNlp+"?"+$.param(paramsNlp));
		...
		setTimeout(function() {
			...
			var iconHelpDesk = $("<img>");
				...
				iconHelpDesk.attr("alt","Prontipagos el mejor aliado para tu negocio, es la mejor plataforma en línea para vender recargas electrónicas, recargas de tiempo aire en tu negocio");
